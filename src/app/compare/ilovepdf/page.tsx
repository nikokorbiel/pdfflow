...
const pricingComparison = [
  { plan: "Free", pdfflow: "Unlimited basic use", competitor: "Limited features" },
  { plan: "Premium", pdfflow: "$9/month", competitor: "$7/month" },
  { plan: "Business", pdfflow: "$19/month", competitor: "$6/user/month" },
];
