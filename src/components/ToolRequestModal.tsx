      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#0a0a0f] border border-[#1e293b] rounded-2xl shadow-2xl"
          >
            {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2.5 rounded-xl bg-[#1e293b] border border-[#334155] text-white placeholder:text-[#64748b] focus:border-[#0ea5e9] focus:outline-none transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={3}
                      className="w-full px-4 py-2.5 rounded-xl bg-[#1e293b] border border-[#334155] text-white placeholder:text-[#64748b] focus:border-[#0ea5e9] focus:outline-none transition-colors resize-none"
                    />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-[#94a3b8] mb-1.5">
                      Email <span className="text-[#64748b]">(optional)</span>
                    </label>
                    <input
                      type="email"
                      value={email}
